...
namespace sql3
{
    ...
    public class QuickSelect : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            // To keep circle in center of screen?
        ...
        void OnGUI()
        {
            ...
            if (showSelectMenu)
            {
                ...
                // divides circle equally depending on number of sectors (inventory icons)
        ...
        void CalculateMouseAngles()
        {
            ...
            // if withinCircle = mouseDistance <= circleRadius then TRUE otherwise FALSE
            ...
            {
                mouseAngles = (Mathf.Atan2(mouse.y - circleCenter.y, mouse.x - circleCenter.x) * 100 / Mathf.PI)
                                + radialRotation;
            }
